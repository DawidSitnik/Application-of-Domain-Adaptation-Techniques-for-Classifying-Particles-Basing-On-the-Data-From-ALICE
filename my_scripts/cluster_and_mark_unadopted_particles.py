...
def main():
    ...
    for i, particle_name in enumerate(Config.particles_list):
        ...
        for model_name in Config.da_models_list:
            ...
            # clustering
            clustered_features_fp = f'{Config.source_fp}/pickles/clustering_last_layer/{model_name}_{particle_name}_last_layer_clustering_som_size_{SOM_SIZE}.pkl'
            if does_file_exist(clustered_features_fp):
                ...
                save_pickle(clustered_features, f'{Config.source_fp}/pickles/clustering_last_layer/{model_name}_{particle_name}_last_layer_clustering.pkl')
            ...
            clusters_summary_fp = f'{Config.source_fp}/tables/cluster_summaries/{model_name}_{particle_name}_clusters_summaries_som_size_{SOM_SIZE}.csv'
            ...
            diffusion_of_biggest_cluster = cluster_summary.iloc[index_of_biggest_cluster]['diffusion']

            unadapted_clusters_list = list(set(cluster_summary[cluster_summary['diffusion'] > diffusion_of_biggest_cluster]['cluster']))
