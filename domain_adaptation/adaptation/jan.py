...
from domain_adaptation.modules.grl import GradientReverseLayer
from domain_adaptation.modules.kernels import GaussianKernel
from .dan import _update_index_matrix


__all__ = ['JointMultipleKernelMaximumMeanDiscrepancy', 'ParticlesClassifier']
...
class ParticlesClassifier(ClassifierBase):
    def __init__(self, backbone: nn.Module, num_classes: int, bottleneck_dim: Optional[int] = 256):
        ...
        super(ParticlesClassifier, self).__init__(backbone.feature_extractor, num_classes, bottleneck, bottleneck_dim, head)