...
__all__ = ['ConditionalDomainAdversarialLoss', 'ParticlesClassifier']
...
class ConditionalDomainAdversarialLoss(nn.Module):
    ...
    Examples::
        ...
        >>> from domain_adaptation.adaptation.cdan import ConditionalDomainAdversarialLoss
        >>> import torch
        >>> num_classes = 2
        >>> feature_dim = 1024
        >>> batch_size = 10
...
class ParticlesClassifier(ClassifierBase):
    def __init__(self, backbone: nn.Module, num_classes: int, bottleneck_dim: Optional[int] = 256):
        ...
        super(ParticlesClassifier, self).__init__(backbone.feature_extractor, num_classes, bottleneck, bottleneck_dim)
