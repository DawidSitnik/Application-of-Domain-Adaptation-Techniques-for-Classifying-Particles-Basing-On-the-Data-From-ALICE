...
from domain_adaptation.modules.kernels import optimal_kernel_combinations


__all__ = ['MultipleKernelMaximumMeanDiscrepancy', 'ParticlesClassifier']
...
class ParticlesClassifier(ClassifierBase):
    def __init__(self, backbone: nn.Module, num_classes: int, bottleneck_dim: Optional[int] = 256):
        ...
        super(ParticlesClassifier, self).__init__(backbone.feature_extractor, num_classes, bottleneck, bottleneck_dim, None)